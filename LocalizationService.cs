            ...
            {"zh", new Dictionary<string, string>()
                {
                    ...
                    { "Informations pour '{0}' ({1}) :\nLe sinogramme traditionnel est : {2}\nLe sinogramme simplifié : {3}\nLa traduction : {4}\n", "关于'{0}'的信息（{1}）：\n传统汉字是：{2}\n简化汉字：{3}\n翻译：{4}\n" },
                    { "PinyinFound", "拼音为：" },
                    { "PinyinNotFound", "找不到拼音：" },
                    { "FrenchTranslation", "法语翻译为：" },
                    { "NoTranslationFound", "未找到以下内容的翻译：" },
                    { "NoSinogramFound", "未找到正弦图：" },
                    { "SinogramsFound", "找到的汉字图：" },
                    { "NoTraditionalFound", "找不到繁体字：" },
                    { "TraditionalFound", "找到的繁体字为：" },
                    { "Traditional", "繁体" },
